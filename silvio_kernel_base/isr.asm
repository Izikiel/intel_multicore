...
%macro ISR_GENERIC_HANDLER 2
        ...
        _isr%1:
            ...
            ;notificarExcepcion(unsigned int errorCode, unsigned int EFLAGS, unsigned int EDI, unsigned int ESI, unsigned int EBP, unsigned int ESP, unsigned int EBX, unsigned int EDX, unsigned int ECX, unsigned int EAX, unsigned int EIP);
            ...
            popfd
            popad
            xchg bx, bx ;nota para mi yo del futuro: es una buena idea parar aca y debugear el iret y revisar si es trap , fault o interrupt para que no lopee en la instr que explota
        iret
%endmacro
