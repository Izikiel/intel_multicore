...

{
	...
	oz_dev_console_init ();		// the big console driver, part 2
	oz_dev_dectulip_init ();	// dec tulip 21041 ethernet driver
...
//	ms_drv_scsiport_init (aic78xx_start, "aic78xx", (void *)0);
}
