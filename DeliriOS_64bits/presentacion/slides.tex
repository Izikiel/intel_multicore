...
\begin{frame}
  ...
  Luego de tener listos los \texttt{icr}, se procede a mandar las \textt{ipi's} de INIT e INIT\_DASSERT, luego se espera unos 10 milisegundos, verificando previamente que las \textt{ipis} se hayan enviado correctamente. \\
  \vspace{10pt}
  ...
  \vspace{10pt}
  Una vez terminado este proceso, se puede asumir que el AP fue encendido, y se continúa el encendido el resto de los AP's encontrados en la \textt{MP Configuration Table}\\
\end{frame}
